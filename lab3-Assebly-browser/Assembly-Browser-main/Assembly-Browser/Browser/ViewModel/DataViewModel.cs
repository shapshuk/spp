            ...
            foreach(var item in namespaces)
            {
                ...
                foreach (var type in item.Classes)
                {
                    ...
                    foreach (var method in type.Methods)
                        typeInfoFlat.ClassElements.Add(method.Name);

                    foreach (var fields in type.Fields)
                        typeInfoFlat.ClassElements.Add(fields.Name);

                    foreach (var property in type.Properties)
                        typeInfoFlat.ClassElements.Add(property.Name);

                    foreach (var constructor in type.Constructors)
                        typeInfoFlat.ClassElements.Add(constructor.Name);
